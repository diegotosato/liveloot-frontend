...
const STATUS_CONTENT_MAP = {
  ...
  processing: {
    text: "Stiamo processando il pagamento...",
    iconColor: "#6D6E78",
    icon: InfoIcon,
  },
  requires_payment_method: {
    text: "Il pagamento non è andato a buon fine, riprova",
    iconColor: "#DF1B41",
    icon: ErrorIcon,
  },
  default: {
    ...
    <>
      <div className="back-gradient vh-100 d-flex align-items-center">
        ...
        <div id="payment-status" className="container card">
          ...
          {intentId && <div id="details-table">
            <table>
              <tbody className="text-center">
                <tr>
                  <td className="TableLabel">Il tuo ordine è in elaborazione. Ricevarai una mail non appena verrà spedito!</td>
          ...
          <NavLink to="/">
            <button id="retry-button" className="rounded-pill">     Vai alla home</button>
          </NavLink>
        </div>
      </div>
    </>
